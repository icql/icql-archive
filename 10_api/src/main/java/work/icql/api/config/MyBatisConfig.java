...
import work.icql.api.common.interceptor.MyBatisSqlCostInterceptor;
 ...
 */
@Configuration
@MapperScan("work.icql.api.mapper*")
public class MyBatisConfig {
    ...
    @Bean
    public SqlSessionFactory sqlSessionFactory(@Qualifier("dynamicDataSource") DataSource dataSource, PageInterceptor pageInterceptor) throws Exception {
