...
<form action="/order/pay" method="post">
    ...
    支付金额：${order.money}元
    <INPUT TYPE="text" NAME="money" value="${order.money}" style="display: none">
